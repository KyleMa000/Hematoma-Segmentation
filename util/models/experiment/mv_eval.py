...
# this model gives flexible leveling also outputs feature map for eval
# it takes in the same weight dict as the multiview model level
class MV_eval(nn.Module):
    def __init__(self, level):
        super(MV_eval, self).__init__()
